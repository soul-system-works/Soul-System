...
ACCEPTED BY:     Judge — RECOMMENDED. Pending Body acceptance before application to
                 philosophy/the-soul.md (philosophy-level).
FILED BY:        Archivist
```
...
Philosophy-level (touches the Architect's obligations). Judge recommends; Body
accepts deliberately before application. On acceptance: apply to the-soul.md +
adr-format.md, move to accepted/, mark F011's topology half resolved (the
knowledge-graph half stays open with its trigger).
